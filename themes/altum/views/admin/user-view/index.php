...
<div class="my-5 row justify-content-between">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-expand-arrows-alt mr-1"></i> <?= l('admin_upscaled_images.menu') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->upscaled_images) ?></span></div>
            </div>

            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/upscaled-images?user_id=' . $data->user->user_id) ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-image-portrait mr-1"></i> <?= l('admin_removed_background_images.menu') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->removed_background_images) ?></span></div>
            </div>

            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/removed-background-images?user_id=' . $data->user->user_id) ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-photo-film mr-1"></i> <?= l('admin_replaced_background_images.menu') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->replaced_background_images) ?></span></div>
            </div>

            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/replaced-background-images?user_id=' . $data->user->user_id) ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
