...
<section class="admin-sidebar">
    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminUpscaledImages']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/upscaled-images') ?>">
                    <i class="fas fa-fw fa-sm fa-expand-arrows-alt mr-2"></i> <?= l('admin_upscaled_images.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminRemovedBackgroundImages']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/removed-background-images') ?>">
                    <i class="fas fa-fw fa-sm fa-image-portrait mr-2"></i> <?= l('admin_removed_background_images.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminReplacedBackgroundImages']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/replaced-background-images') ?>">
                    <i class="fas fa-fw fa-sm fa-photo-film mr-2"></i> <?= l('admin_replaced_background_images.menu') ?>
                </a>
            </li>
