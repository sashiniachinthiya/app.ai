        ...
        <div class="card">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?= $data->type == 'upscaled_images' ? 'active' : null ?>" href="<?= url('admin/statistics/upscaled_images?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-expand-arrows-alt mr-1"></i> <?= l('admin_statistics.upscaled_images.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'removed_background_images' ? 'active' : null ?>" href="<?= url('admin/statistics/removed_background_images?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-image-portrait mr-1"></i> <?= l('admin_statistics.removed_background_images.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'replaced_background_images' ? 'active' : null ?>" href="<?= url('admin/statistics/replaced_background_images?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-photo-film mr-1"></i> <?= l('admin_statistics.replaced_background_images.menu') ?></a>
