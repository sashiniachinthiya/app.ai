...
<div class="mb-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/documents') ?>" class="stretched-link">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-feather mr-1"></i> <?= l('admin_documents.words_current_month') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->words_current_month) ?></span></div>
            </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/images') ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-camera-retro mr-1"></i> <?= l('admin_images.images_current_month') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->images_current_month) ?></span></div>
            </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/transcriptions') ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-volume-up mr-1"></i> <?= l('admin_transcriptions.transcriptions_current_month') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->transcriptions_current_month) ?></span></div>
            </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/chats') ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-quote-right mr-1"></i> <?= l('admin_chats.chats_current_month') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->chats_current_month) ?></span></div>
            </div>
