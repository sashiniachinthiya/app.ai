...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fas fa-fw fa-xs fa-photo-film text-primary-900 mr-2"></i> <?= l('admin_replaced_background_images.header') ?></h1>
        ...
        <div>
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/replaced-background-images?' . $data->filters->get_get() . '&export=csv') ?>" target="_blank" class="dropdown-item">
                        <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/replaced-background-images?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_scale" class="small"><?= l('replaced_background_images.scale') ?></label>
...
<form id="table" action="<?= SITE_URL . 'admin/replaced-background-images/bulk' ?>" method="post" role="form">
            ...
            <?php foreach($data->replaced_background_images as $row): ?>
                ...
                <tr>
                    <td data-bulk-table class="d-none">
                        <div class="custom-control custom-checkbox">
                            <input id="selected_replaced_background_image_id_<?= $row->replaced_background_image_id ?>" type="checkbox" class="custom-control-input" name="selected[]" value="<?= $row->replaced_background_image_id ?>" />
                            <label class="custom-control-label" for="selected_replaced_background_image_id_<?= $row->replaced_background_image_id ?>"></label>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/replaced-background-images/admin_replaced_background_image_dropdown_button.php', ['id' => $row->replaced_background_image_id, 'resource_name' => $row->name, 'replaced_background_image' => $row->replaced_background_image, 'replaced_background_image_url' => \Altum\Uploads::get_full_url('replaced_background_images') . $row->replaced_background_image]) ?>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
