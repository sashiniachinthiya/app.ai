        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_free->color ? 'border-color: ' . settings()->plan_free->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center text-uppercase p-2 bg-gray-25 text-muted rounded"><?= settings()->plan_free->translations->{\Altum\Language::$name}->name ?: settings()->plan_free->name ?></div>
                    </div>
        ...
        >
            <div class="card pricing-card h-100" style="<?= $plan->color ? 'border-color: ' . $plan->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3 text-center p-2 bg-gray-25 rounded">
        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_custom->color ? 'border-color: ' . settings()->plan_custom->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center text-uppercase p-2 bg-gray-25 text-muted rounded"><?= settings()->plan_custom->translations->{\Altum\Language::$name}->name ?: settings()->plan_custom->name ?></div>
                    </div>
