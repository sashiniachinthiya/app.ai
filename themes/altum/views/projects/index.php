...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><i class="fas fa-fw fa-xs fa-diagram-project mr-1"></i> <?= l('projects.header') ?></h1>
                            ...
                            <td class="text-nowrap">
                                <div class="d-flex align-items-center">
                                    ...
                                    <?php if(settings()->aix->syntheses_is_enabled): ?>
                                        <a href="<?= url('syntheses?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('syntheses.title') ?>">
                                            <i class="fas fa-fw fa-voicemail text-muted"></i>
                                        </a>
                                    <?php endif ?>
                                </div>
                            </td>
