...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><i class="fas fa-fw fa-xs fa-icons mr-1"></i> <?= l('images.header') ?></h1>
        ...
        <div class="col-12 col-lg-auto d-flex d-print-none">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('image-create') ?>" class="btn btn-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->images_current_month, $this->user->plan_settings->images_per_month_limit, isset($data->filters) ? !$data->filters->has_applied_filters : true) ?>">
                        <i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('images.create') ?>
                    </a>
                <?php endif ?>
            </div>
    ...
    <?php if(count($data->images)): ?>
        <form id="table" action="<?= SITE_URL . 'images/bulk' ?>" method="post" role="form">
