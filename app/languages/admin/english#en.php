...
return [
    ...
    'admin_plans.plan.upscaled_images_per_month_limit' => 'AI Upscaled Images',
    'admin_plans.plan.upscaled_images_file_size_limit' => 'AI Upscaled Images file size limit',
    'admin_plans.plan.upscaled_images_file_size_limit_help' => 'Maximum 30MB - limited by the ClipDrop API. You are not able to set a higher limit than your actual server upload limit.',
    'admin_plans.plan.removed_background_images_per_month_limit' => 'AI Removed Background Images',
    'admin_plans.plan.removed_background_images_file_size_limit' => 'AI Removed Background Images file size limit',
    'admin_plans.plan.removed_background_images_file_size_limit_help' => 'Maximum 30MB - limited by the CLipDrop API. You are not able to set a higher limit than your actual server upload limit.',
    'admin_plans.plan.replaced_background_images_per_month_limit' => 'AI Replaced Background Images',
    'admin_plans.plan.replaced_background_images_file_size_limit' => 'AI Replaced Background Images file size limit',
    'admin_plans.plan.replaced_background_images_file_size_limit_help' => 'Maximum 30MB - limited by the CLipDrop API. You are not able to set a higher limit than your actual server upload limit.',
    ...
    'admin_user_view.title' => 'View user - %s',
    ...
    'admin_settings.documentation' => 'Read the <a href="https://altumco.de/66aix-docs" target="_blank">Documentation</a> to get more details on certain available configurations.',
    ...
    'admin_settings.aix.openai_api_key_help' => 'You can insert multiple OpenAI API Keys per line and the system will randomly choose one on each request.',
    'admin_settings.aix.clipdrop_api_key' => 'ClipDrop - API Key',
    'admin_settings.aix.clipdrop_api_key_help' => 'You can insert multiple ClipDrop API Keys per line and the system will randomly choose one on each request.',
    ...
    'admin_settings.aix.upscaled_images_is_enabled' => 'Enable the AI Image Upscaler system',
    'admin_settings.aix.removed_background_images_is_enabled' => 'Enable the AI Image Background Remover system',
    'admin_settings.aix.replaced_background_images_is_enabled' => 'Enable the AI Image Background Replacer system',
    ...
    'admin_settings.aix.aws_access_key' => 'AWS - Access key',
    'admin_settings.aix.aws_secret_access_key' => 'AWS - Secret access key',
    'admin_settings.aix.aws_region' => 'AWS - Region',
    ...
    'admin_statistics.upscaled_images.menu' => 'AI Upscaled Images',
    'admin_statistics.upscaled_images.header' => 'AI Upscaled Images',
    'admin_statistics.upscaled_images.chart' => 'New AI Upscaled Images',

    'admin_statistics.removed_background_images.menu' => 'AI Removed Bg. Images',
    'admin_statistics.removed_background_images.header' => 'AI Removed Background Images',
    'admin_statistics.removed_background_images.chart' => 'New AI Removed Background Images',

    'admin_statistics.replaced_background_images.menu' => 'AI Replaced Bg. Images',
    'admin_statistics.replaced_background_images.header' => 'AI Replaced Background Images',
    'admin_statistics.replaced_background_images.chart' => 'New AI Replaced Background Images',
    ...
    'admin_documents.words_current_month' => 'Words this month',


    'admin_images.title' => 'AI Images',
    'admin_images.header' => 'AI Images',
    'admin_images.menu' => 'AI Images',
    'admin_images.images_current_month' => 'Images this month',


    'admin_upscaled_images.title' => 'AI Upscaled images',
    'admin_upscaled_images.header' => 'AI Upscaled images',
    'admin_upscaled_images.menu' => 'AI Upscaled images',
    'admin_upscaled_images.images_current_month' => 'Upscaled images this month',


    'admin_removed_background_images.title' => 'AI Removed Background images',
    'admin_removed_background_images.header' => 'AI Removed Background images',
    'admin_removed_background_images.menu' => 'AI Removed Bg. images',


    'admin_replaced_background_images.title' => 'AI Replaced Background images',
    'admin_replaced_background_images.header' => 'AI Replaced Background images',
    'admin_replaced_background_images.menu' => 'AI Replaced Bg. images',
    ...
    'admin_transcriptions.transcriptions_current_month' => 'Transcriptions this month',
